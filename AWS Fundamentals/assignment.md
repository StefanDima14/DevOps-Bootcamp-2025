...
At the end of the assignment I learned how to create related resources to be able to deploy a functional virtual machine in AWS and how to use the SSH to connect between the instances
